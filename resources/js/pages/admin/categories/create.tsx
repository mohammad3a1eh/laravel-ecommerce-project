    ...
    const onSubmit = (data: CategoryFormValues) => {
        ...
        router.post(route("admin.categories.store"), formData, {
            ...
            onError: (serverErrors) => {
                ...
                // map errors from backend to form fields
                Object.entries(serverErrors).forEach(([key, message]) => {
                    setError(key as keyof CategoryFormValues, {
                        type: 'server',
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <form onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data" className="space-y-4" autoComplete="off">
                                ...
                                <div className="relative w-40 h-40 mx-auto my-auto">
                                    ...
                                    <Button
                                        ...
                                        onClick={() => {
                                            ...
                                            // register('image').onChange({ target: { files: null } });
                                        }}
                                    >
                                ...
                                <div className="relative aspect-4/1  mx-auto">
                                    ...
                                    <Button
                                        ...
                                        onClick={() => {
                                            ...
                                            // register('banner').onChange({ target: { files: null } });
                                        }}
                                    >
                                        <Trash width={12} height={12} />
                                    </Button>
                    ...
                    <div className="flex flex-col gap-2 mt-4 sm:flex-row">
                        ...
                        {/*<Button type="submit" name="action" value="saveAndEdit">*/}
